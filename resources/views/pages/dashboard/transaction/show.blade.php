<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h2 class="font-semibold text-lg text-gray-800 leading-tight mb-5 " style="margin-bottom: 10px;">Transaction Details</h2>
            ...
            <h2 class="font-semibold text-lg text-gray-800 leading-tight mb-5 " style="margin-bottom: 10px; margin-top: 10px;">Transaction Items</h2>
